...
public final class PixelRank extends JavaPlugin {
    ...
    private void loadConfig() {
        ...
        Configuration.setDefault("leaderboards.mining_rank", "Mining", "採掘ランキングのタイトル");
        Configuration.setDefault("leaderboards.placing_rank", "Placement", "設置ランキングのタイトル");
        Configuration.setDefault("leaderboards.online_time_rank", "Online Time", "プレイ時間ランキングのタイトル");
        Configuration.setDefault("leaderboards.death_rank", "Death", "死亡ランキングのタイトル");
        Configuration.setDefault("leaderboards.movement_rank", "Movement", "移動距離ランキングのタイトル");
        Configuration.setDefault("leaderboards.mob_kill_rank", "Mob Kills", "モブ討伐ランキングのタイトル");
        Configuration.setDefault("leaderboards.jump_rank", "Jumps", "ジャンプ回数ランキングのタイトル");
        Configuration.setDefault("leaderboards.money_rank", "Money", "所持金ランキングのタイトル");
